...
const heritageIconAssets: Record<HeritageIconName, string> = {
  ...
  'activity-construction': 'activity-construction',
  'activity-funeral': 'activity-funeral',
  'activity-house-purchase': 'activity-house-purchase',
  'activity-moving': 'activity-moving',
  'activity-opening': 'activity-opening',
  'activity-travel': 'activity-travel',
  'activity-vehicle': 'activity-vehicle',
  'activity-wedding': 'activity-wedding',
  analytics: 'grid',
